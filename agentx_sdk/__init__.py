...
# upgrading operator nothing; the minor bump is the one signal read without a changelog.
# (0.4.32 was cut in the tree and never published, so the number was free.)
